										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start">
												...
												<div class="menu-sub menu-sub-dropdown w-175px py-4">
													...
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="../../demo8/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">Latest Orders
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link active" href="../../demo8/dist/dashboards/marketing.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="toolbar d-flex align-items-stretch">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Marketing Dashboard</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Marketing</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="card">
									...
									<div class="card-header card-header-stretch">
										...
										<div class="card-title">
											<h3 class="m-0 text-gray-800">Last Order</h3>
										</div>
										<!--end::Title-->
										<!--begin::Toolbar-->
												...
												<table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
													...
													<thead class="border-gray-200 fs-5 fw-semibold bg-lighten">
														<tr>
															...
															<th class="min-w-350px">Product name</th>
													...
													<tbody class="fs-6 fw-semibold text-gray-600">
                                                        ...
                                                        <tr>
															...
															<td class="ps-9">{{$order->id}}</td>
															<td>
																<select class="form-control select2-no-search" name="">
																	{{-- <option label="Products" selected disabled></option> --}}
																		@foreach($order->products as $product)
																			<option>{{$product->ar_name}}</option>
																		@endforeach
																</select>
															</td>
						...
						<!--begin::Post-->
								...
								<div class="card">
									...
									<div class="card-header card-header-stretch">
										<!--begin::Title-->
										<div class="card-title">
											<h3 class="m-0 text-gray-800">Last Users</h3>
										</div>
										<!--end::Title-->
										<!--begin::Toolbar-->
										<div class="card-toolbar m-0">
										...
										<div id="kt_referrals_1" class="card-body p-0 tab-pane fade show active" role="tabpanel">
											<div class="table-responsive">
												...
												<table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
													...
													<thead class="border-gray-200 fs-5 fw-semibold bg-lighten">
														<tr>
															<th class="min-w-175px ps-9">Frist Name</th>
															<th class="min-w-150px px-0">L-Name</th>
													...
													<tbody class="fs-6 fw-semibold text-gray-600">
                                                        ...
                                                        <tr>
															<td class="ps-9">{{$user->fname}}</td>
															<td class="ps-0">{{$user->lname}}</td>
															<td class="ps-0">{{$user->email}}</td>
															<td class="ps-0">{{$user->phone}}</td>
															<td class="ps-0">{{$user->user_type}}</td>
                                                            @endforeach
														</tr>
													</tbody>
													<!--end::Tbody-->
					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo8/dist/documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo8/dist/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo8/dist/documentation/getting-started/changelog.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New</a>
									<!--end::Title-->
									<!--begin::Description-->
