...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body data-kt-name="metronic" id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-white position-relative">
						...
						<div class="container">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="flex-equal text-end ms-1">
									<a href="../../demo8/dist/authentication/layouts/basic/sign-in.html" class="btn btn-success">Sign In</a>
								</div>
								<!--end::Toolbar-->
							</div>
							<!--end::Wrapper-->
							...
							<div class="col-lg-6 ps-lg-16">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="d-flex fw-semibold flex-column me-20">
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../demo8/dist/documentation/getting-started.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Documentaions</a>
										<!--end::Link-->
										<!--begin::Link-->
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../demo8/dist/documentation/getting-started/changelog.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Changelog</a>
										<!--end::Link-->
										<!--begin::Link-->
